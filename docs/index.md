...
- [Laya System-1 decision plane](decision-plane.md)
- [Decision topology and A-E inventory](decision-topology.md)
- [Build and release runbook](build-and-release.md)
- [Test plan](testing.md)
- [Component evaluation notes](candidate-components.md)

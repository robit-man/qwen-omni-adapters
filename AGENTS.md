...
- successful informational probes do not count as milestone progress; progress
  and completion cite a typed source acquisition, mutation, external
  interaction, or verification receipt.
